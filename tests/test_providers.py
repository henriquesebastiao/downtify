...
def test_artist_full_top_songs_resolves_shelf_playlist(monkeypatch):
    ...
    playlists = {
        'VLPLshelf123': {
            ...
            'tracks': [
                _song_row('Quiet Static', 'Mica Ferreira', 'Driftlight', 200, 'aaaaaaaaaaa'),
                _song_row('Held Together', 'Mica Ferreira', 'Driftlight', 210, 'bbbbbbbbbbb'),
                _song_row('Runaway', 'Mica Ferreira', 'Driftlight', 190, 'ccccccccccc'),
            ],
        }
    }
    monkeypatch.setattr(
...
def test_artist_full_top_songs_returns_empty_when_no_browse_id(monkeypatch):
    artist_data = {
        'name': 'Mica Ferreira',
        'songs': {'results': [_artist_song_row('aaaaaaaaaaa', 'Quiet Static')]},
    }
    monkeypatch.setattr(
