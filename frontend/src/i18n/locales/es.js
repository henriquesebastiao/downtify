export default {
  ...
  search: {
    ...
    playlistBatchesTitle: 'Listas incompletas',
    playlistBatchesHint:
      'Listas con pistas pendientes o descargas en curso. Usa el Monitor de listas para ver todas y activar vigilancia automática.',
  ...
  monitor: {
    ...
    subtitle:
      'Listas que has descargado con Downtify. Activa la vigilancia automática para encolar faltantes y detectar nuevas pistas de Spotify según un intervalo.',
    watchNew: 'Vigilancia automática',
    failedAdd:
    ...
    everyIntervalAt: 'Cada {interval} a las {time}',
    ...
    info: 'La vigilancia automática actualiza la lista desde Spotify y encola las pistas que aún no están en tu biblioteca. En intervalos diarios o más largos puedes elegir una hora. Usa Descargar pendientes para reintentar fallos al momento.',
    every15: 'Cada 15 min',
    every30: 'Cada 30 min',
    every1h: 'Cada hora',
    every3h: 'Cada 3 h',
