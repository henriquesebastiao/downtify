export default {
  ...
  nav: {
    ...
    organizer: 'Regras do Organizador',
  ...
  library: {
    ...
    search: 'Pesquisar por nome de arquivo, ID do Spotify ou playlist…',
    direct: 'Download direto',
    deleteFile: 'Remover da lista',
    play: 'Reproduzir',
  },
  organizer: {
    ...
    targetArtist: 'Mapear para artista',
    addRule: 'Adicionar regra',
    addAlias: 'Adicionar alias',
    filterRules: 'Filtrar regras…',
    filterFolder: 'Todas as pastas',
    save: 'Salvar regras',
    saved: 'Salvo. O organizador aplicará as novas regras na próxima execução.',
    saveError: 'Não foi possível salvar as regras.',
    unsaved: 'Alterações não salvas',
    ruleCount: '{n} regras',
    groupByFolder: 'Agrupar por pasta',
    newKeyword: 'palavra-chave',
