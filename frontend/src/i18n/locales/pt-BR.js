export default {
  ...
  search: {
    ...
    playlistBatchesTitle: 'Playlists incompletas',
    playlistBatchesHint:
      'Playlists com faixas faltando ou downloads em andamento. Use o Monitor de playlists para ver todas e ativar monitoramento automático.',
    ...
    playlistBatchesSearchPlaceholder: 'Filtrar playlists ou títulos de faixas…',
    playlistBatchesNoMatch: 'Nenhuma playlist corresponde ao filtro.',
    playlistBatchesNoTrackMatch:
      'Nenhuma faixa pendente corresponde ao filtro nesta playlist.',
    playlistBatchesNoMissingLoaded:
      'Lista de faltantes não carregou — recolha e expanda de novo, ou limpe o filtro.',
  ...
  queue: {
    ...
    forceSlskd: 'Usar arquivo do slskd',
    overridePlaceholder: 'Cole uma URL do YouTube ou YouTube Music…',
    youtubeOverrideHint:
      'Cole um link do YouTube; os metadados do Spotify são mantidos.',
    slskdOverridePeer: 'Par (usuário)',
    slskdOverridePeerPlaceholder: 'Manelo',
    slskdOverrideFolder: 'Caminho da pasta',
    slskdOverrideFolderPlaceholder:
      '@@wibgr\\EUROPA & EUROVISIÓN\\Ivi Adamou - San Ena Oniro (2012)',
    slskdOverrideFile: 'Nome do arquivo',
    slskdOverrideFilePlaceholder:
      '06 - Ivi Adamou, Melisses - Krata Ta Matia Sou klista.mp3',
    slskdOverrideHint:
      'Copie cada linha do slskd: usuário, pasta (@@…) e nome do .mp3. O Downtify junta pasta e arquivo.',
    applyOverride: 'Aplicar',
    invalidYouTubeURL: 'URL do YouTube inválida',
    invalidSlskdOverride: 'Preencha par, pasta e nome do arquivo.',
  },
  library: {
    title: 'Biblioteca',
  ...
  monitor: {
    ...
    subtitle:
      'Playlists que você baixou pelo Downtify. Ative o monitoramento automático para enfileirar faltantes e pegar novas faixas do Spotify em intervalos.',
    watchNew: 'Monitoramento automático',
    failedAdd:
    ...
    info: 'O monitoramento automático atualiza a playlist no Spotify e enfileira faixas que ainda não estão na biblioteca. Em intervalos diários ou maiores você pode escolher um horário. Use Baixar faltantes para repetir falhas na hora.',
