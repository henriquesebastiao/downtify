export default {
  ...
  monitor: {
    ...
    subtitle:
      'Add Spotify playlists or artists to watch. New tracks and new releases will be downloaded automatically.',
    watchNew: 'Watch a new playlist or artist',
    urlPlaceholder: 'Paste a Spotify playlist or artist URL…',
    watch: 'Watch',
    ...
    info: 'When you add a playlist, Downtify downloads every track it currently contains and then keeps watching it. Any songs added later on Spotify are detected and downloaded automatically on the next scheduled check. Adding an artist works the same way: Downtify downloads their discography, then watches for new releases.',
