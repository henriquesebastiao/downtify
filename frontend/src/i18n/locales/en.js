export default {
  ...
  monitor: {
    ...
    urlLabel: 'Playlist or artist link',
    urlPlaceholder:
      'Paste a Spotify or YouTube Music playlist, or a YouTube Music artist',
    interval: 'Check every',
    watch: 'Watch',
    addFailed: "Couldn't watch that link. Check it and try again.",
    explainer:
      'Adding a playlist downloads everything on it now, then checks it on schedule and downloads whatever gets added. Artists work the same way with new releases.',
    checkAll: 'Check all now',
    checkNow: 'Check now',
    checking: 'Checking {name}…',
    checkingAll: 'Checking every active watch…',
    emptyTitle: 'Nothing watched yet',
    emptyBody: 'Paste a playlist or artist link above to keep it in sync.',
    filterAll: 'All',
