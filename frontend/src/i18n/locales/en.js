export default {
  ...
  search: {
    ...
    playlistBatchesHint:
      'Playlists still missing tracks or with downloads in progress. Use Playlist Monitor for the full list and auto-watch.',
  ...
  monitor: {
    ...
    subtitle:
      'Playlists you have downloaded via Downtify. Turn on auto-watch to queue missing tracks and pick up new Spotify additions on a schedule.',
    watchNew: 'Auto-watch',
    failedAdd: 'Could not load playlists. Is the backend up to date?',
    empty: 'No playlists tracked yet.',
    emptyHint:
      'Download a Spotify playlist from Search first — it will show up here.',
    active: 'Active',
    paused: 'Paused',
    everyInterval: 'Every {interval}',
    everyIntervalAt: 'Every {interval} at {time}',
    checked: 'Checked {when}',
    notChecked: 'Not checked yet',
    checkNow: 'Check now',
    checkTimeHint:
      'Time of day for daily (or longer) checks — uses your browser’s local timezone.',
    info: 'Auto-watch periodically refreshes the playlist from Spotify and queues any tracks that are not in your library yet. For daily or longer intervals you can pick a time of day. Use Download missing to retry failed or skipped tracks immediately.',
