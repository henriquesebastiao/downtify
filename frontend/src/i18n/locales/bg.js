export default {
  ...
  settings: {
    ...
    downloadCoverArtPlaylists: 'Изтегляне на корицата на плейлиста',
    downloadCoverArtPlaylistsHint:
      'Взима обложката на плейлиста и я запазва в Playlists/<име>.jpeg. Изключете, за да не се изтегля корицата.',
    audioSourceHint:
