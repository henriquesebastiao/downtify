...
[`docker-compose.example.yml`](../../docker-compose.example.yml) uses **`dx616b/spoti-to-navidrome:2.7.7`**, maps `/downloads` and `/slskd`, and listens on port `30321` inside the container (`8000:30321` on the host).
